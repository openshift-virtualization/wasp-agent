...
require (
	...
	k8s.io/gengo 2b36238f13e9 // indirect
...
require (
	...
	github.com/google/pprof 40e02aabc2ad // indirect
	github.com/karrick/godirwalk v1.17.0 // indirect
	github.com/matttproud/golang_protobuf_extensions/v2 v2.0.0 // indirect
	github.com/mistifyio/go-zfs 9b43ea0d2c5e // indirect
...
require (
	...
	k8s.io/kube-openapi 99599406b04f // indirect
...
replace k8s.io/component-helpers => k8s.io/component-helpers v0.31.4
...
replace (
	...
	github.com/operator-framework/operator-lifecycle-manager => github.com/operator-framework/operator-lifecycle-manager v0.29.0
...
replace k8s.io/controller-manager => k8s.io/controller-manager v0.31.4

replace k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.31.4

replace k8s.io/kms => k8s.io/kms v0.31.4

replace k8s.io/mount-utils => k8s.io/mount-utils v0.31.4

replace k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.31.4
