...
require (
	...
	github.com/mistifyio/go-zfs 2a28eb653910 // indirect
...
replace (
	github.com/openshift/api => github.com/openshift/api 44bef346c3f0
	github.com/openshift/client-go => github.com/openshift/client-go 89e5bba1be29
