...
require (
	...
	k8s.io/gengo 0359904fc2a6 // indirect
...
require (
	...
	google.golang.org/genproto/googleapis/rpc 1a7da9e5054f // indirect
...
replace (
	github.com/openshift/api => github.com/openshift/api 366ffb8c60da
