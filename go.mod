...
replace (
	github.com/openshift/api => github.com/openshift/api 88b2b21555f3
	...
	github.com/operator-framework/operator-lifecycle-manager => github.com/operator-framework/operator-lifecycle-manager v0.33.0
